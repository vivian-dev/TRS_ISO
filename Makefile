...
IMPLEMENTATION_SOURCE = seedtree.c lrsign.c rsign.c trsign.c  test.c
IMPLEMENTATION_HEADERS= seedtree.h lrsign.h rsign.h trsign.h parameters.h 
...
test_trs_iso: $(IMPLEMENTATION_SOURCE) $(IMPLEMENTATION_HEADERS) ClassGroupAction/libclassgroup.a keccaklib
	gcc -o test_trs_iso $(IMPLEMENTATION_SOURCE) $(CFLAGS) -I ClassGroupAction/p512/ -I ClassGroupAction/ -DTEST_TRACEABLE -DISOGENY -L ClassGroupAction/ -lclassgroup $(LFLAGS) -std=c11 -O3 -g -march=native 
